...
{
    public partial class ContractStationSuccess
    {
        public string IdContractStationSuccess { get; set; }
        ...
        public string ContractSuccessFFile { get; set; }
        public string ContractSuccessCreateUser { get; set; }
        public DateTime ContractSuccessCreateDate { get; set; }
        public string ContractSuccessEditUser { get; set; }
        public DateTime ContractSuccessEditDate { get; set; }
