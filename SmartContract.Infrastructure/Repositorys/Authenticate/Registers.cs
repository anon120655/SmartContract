            ...
            using (var _transaction = _repo.BeginTransaction())
            {
				...
				try
                {
                    ...
                    if (!indata.CheckRegister)
                    {
                        ...
                        //var ecContractVendorOwner = new EcContractVendorOwner();

                        //ecContractVendorOwner.CreatedUser = 1;
                        //ecContractVendorOwner.CreatedDate = DateTime.Now;
                        //ecContractVendorOwner.EditedUser = 1;
                        //ecContractVendorOwner.EditedDate = DateTime.Now;
                        //ecContractVendorOwner.Used = "Y";

                        //await _db.InsterAsync(ecContractVendorOwner);
                        //await _db.SaveAsync();
