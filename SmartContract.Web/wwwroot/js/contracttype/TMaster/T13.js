...
$(function () {
    ...
    setDateThai($(`input[name='InfoConDetail.ContractDetail13.P3']`));
...
$(".OperatorRadios").change(function () {
    OperatorRadios();
});

function OperatorRadios() {
    //if ($("#OperatorRadios1").is(":checked")) {
    //    $('#OperatorRadios_Deail').show();
    //}
    //else if ($("#OperatorRadios2").is(":checked")) {
    //    $('#OperatorRadios_Deail').hide();
    //}
}
